...
d3.addModule(
{
	...
	run: function()
	{
		d3.service.embedScript(
			" Colors = { " 
			+"text_color: '#000000', header_color: '#556e8c', links_color: '#556e8c', links_visited_color: '#666666', links_system_color: '#888888', irony_color: '#CC3333', inputs_bg_color: '#e9dfc3',"
			+"inputs_text_color: '#000000', inputs_text_blur_color: '#888888', inputs_border_color: '#E9E9E9', inputs_border_top_color: '#CCCCCC', background_color: '#FFFFFF', footer_gradient_color: '#969696',"
