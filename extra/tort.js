...
d3.addModule(
{
	...
	run: function()
	{
		...
		+ '.b-comments_controls_social {display: inline; padding: 5px 0px 0px 5px;} .b-comments_controls_sort{display: inline;} .b-menu{display: inline;} .b-file_uploader{ width: 550px;}';
