...
d3.addModule(
{
	...
	drawButtons: function()
	{
			...
			,innerHTML: '<div id="home" style="height:32px; width:32px; color:#516f8d; background-image: url(data:image/png;base64,); cursor: pointer; cursor: hand; text-align:center; margin-bottom: 10px;" title="В начало страницы"></div>'
						...
						+ '<div id="down" style="height:31px; width:32px; color:#516f8d; text-shadow: 1px 1px 1px #fff; background-image: url(data:image/png;base64,); cursor: pointer; cursor: hand; text-align:center; padding: 1px 0px 0px 0px;" title="Следующий новый"></div>'
